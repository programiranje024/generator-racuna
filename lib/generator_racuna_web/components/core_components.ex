defmodule GeneratorRacunaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(GeneratorRacunaWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(GeneratorRacunaWeb.Gettext, "errors", msg, opts)
    # end
